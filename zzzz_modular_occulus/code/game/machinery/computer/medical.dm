		...
		if (src.authenticated)
			...
			if (href_list["field"])
				...
				switch(href_list["field"])
					...
					if("sex")
						if (istype(src.active1, /datum/data/record))
							src.active1.fields["sex"] = next_in_list(src.active1.fields["sex"], list("Male","Female","Gender Neutral","Non-Personal"))
					if("id_gender")
						if (istype(src.active2, /datum/data/record))
							src.active2.fields["id_gender"] = next_in_list(src.active2.fields["id_gender"], list("Male","Female","Gender Neutral","Non-Personal"))
					if("age")
						if (istype(src.active1, /datum/data/record))
