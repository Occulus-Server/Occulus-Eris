/////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////Siren Explosions proc. For siren ka-boom./////////////////////////////////////
///////////////////////Yes, this is shameless mostly copy pasting.///////////////////////////////////
///////////////////////No, I don't have a choice.////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////


/proc/siren_explosion(turf/epicenter, devastation_range, heavy_impact_range, light_impact_range, flash_range, adminlog = 1, z_transfer = UP|DOWN)
	spawn(0)
		...
		if(devastation_range > 2 || heavy_impact_range > 2)
			if(HasAbove(epicenter.z) && z_transfer & UP)
				siren_explosion(GetAbove(epicenter), max(0, devastation_range - 2), max(0, heavy_impact_range - 2), max(0, light_impact_range - 2), max(0, flash_range - 2), 0, UP)
			if(HasBelow(epicenter.z) && z_transfer & DOWN)
				siren_explosion(GetBelow(epicenter), max(0, devastation_range - 2), max(0, heavy_impact_range - 2), max(0, light_impact_range - 2), max(0, flash_range - 2), 0, DOWN)
