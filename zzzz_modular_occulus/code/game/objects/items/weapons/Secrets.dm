...
/obj/item/weapon/paper/gospel
	...
	<br>
	and I am on a broken shore,<br>
	staring through the dusty wind,<br>
	at the clouds above.<br>
	<br>
	I wonder,<br>
	if they’re floating,<br>
	or sinking past me.<br>
	<br>
	And I open up my eyes,<br>
	to ask if they see their distant cousins,<br>
...
/obj/item/weapon/paper/hivemind
	...
	<br>
	Despite the valiant efforts of our security contractors and intensive eradication efforts, we’ve as of yet not been able to fully rid the ship of it. Though it can be fought back and seemingly temporarily destroyed, it has shown the capability to emerge after some time and begin it’s attempted conquest once again.<br>
	<br>
	Through the noble sacrifice of one of our Junior Research Assistants, we have been able to contain a small amount of material sourced from the Hivemind. Captain Lovelace is preparing a brief obituary and letters to the assistant’s immediate family, which will be included with this report.<br>
	<br>
	Our team has been able to extract a significant amount of data from the sample, and much of it suggests that we will be able to extract exponentially more if we were to obtain a larger sample. The most curious aspect of what we have discovered is that much of the code that we have been able to decrypt points towards the Church of Mekhane.<br> 
	<br>
	While we do not know how the Church is involved or related to the Hivemind, Father *illegible* has been more than helpful and cooperative, providing texts and samples of their own software for comparison. As far as our analysis can tell, while the code of the Hivemind refers to Mekhane, it is unlikely that the Church had a hand in it’s creation, given the limited scope of their equipment on the ship. I have asked EES to pay close attention and notify me of any anomalous power readings from the Church. Better safe than sorry.<br>
	<br>
	As always, we will continue to work hard to unlock the secrets of this ship.<br>
	<br>
	Regards,<br>
	<br>
	Dr. Zaqel Qarxik<br>
