/obj/item/implant/carrion_spider/smoker
	name = "smoker spider"
...
/obj/item/implant/carrion_spider/smoker/New()
	..()
	smoke = new
	smoke.attach(src)

/obj/item/implant/carrion_spider/smoker/Destroy()
	qdel(smoke)
	smoke = null
	return ..()


/obj/item/implant/carrion_spider/smoker/activate()
