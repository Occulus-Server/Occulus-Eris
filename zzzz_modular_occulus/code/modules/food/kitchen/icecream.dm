...
/obj/machinery/icecream_vat
	name = "icecream vat"
	desc = "Ding-aling ding dong. Get your roach free ice cream!"
		...
		if(!I.ice_creamed)
			...
			//		beaker.reagents.trans_to(I, 10)
				if(I.reagents.total_volume < 10)
					I.reagents.add_reagent("nutriment", 10 - I.reagents.total_volume,  list("[flavour_name]" = 7, "[I.cone_type]" = 3))
			else
...
/obj/item/reagent_containers/food/snacks/icecream/proc/add_ice_cream(var/flavour_name)
	...
	ice_creamed = 1
	nutriment_desc = list("[flavour_name]" = 3,"[cone_type]" =1)
