...
/obj/item/device/defib_kit/loaded //starts with a cell
	bcell = /obj/item/cell/large/high
...
/obj/item/shockpaddles/attack_self(mob/user) //Toggle overcharge on and off.
...
/obj/item/shockpaddles/update_wield_icon()
	..()
...
/obj/item/shockpaddles/update_unwield_icon()
	..()
	if(!wielded && wielded_icon)
		item_state_slots = list(
			slot_l_hand_str = "defibpaddles_left",
...
/obj/item/shockpaddles/linked/check_overchargecell() // Check if the cell is large enough to allow overcharge.
	return(base_unit.bcell.maxcharge >= overchargecost)

/obj/item/shockpaddles/proc/check_overchargecell()
	return 0

/obj/item/shockpaddles/linked/check_overchargecharge() // Check if the cell has enough charge to allow overcharge.
	return(base_unit.bcell.charge >= overchargecost)

/obj/item/shockpaddles/proc/check_overchargecharge()
	return 0

/obj/item/shockpaddles/linked/overchargedrain() // Drain the charge from the battery after an overcharge shock.
	base_unit.bcell.use(overchargecost)
	base_unit.update_icon()

/obj/item/shockpaddles/proc/overchargedrain()
	return 0
