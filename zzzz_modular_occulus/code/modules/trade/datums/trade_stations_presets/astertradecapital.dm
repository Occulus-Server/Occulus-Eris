/datum/trade_station/asterstradecapital
	...
	inventory = list(
		"Disk Designs" = list(
			/obj/item/computer_hardware/hard_drive/portable/design/tools = good_data("Basic Tool Pack", list(1, 10), null),
			/obj/item/computer_hardware/hard_drive/portable/design/misc = good_data("Miscellaneous Pack", list(1, 10), null),
			/obj/item/computer_hardware/hard_drive/portable/design/robustcells = good_data("Robustcells", list(1, 10), null),
			/obj/item/computer_hardware/hard_drive/portable/design/devices = good_data("Devices and Instruments", list(1, 10), null),
			/obj/item/computer_hardware/hard_drive/portable/design/nonlethal_ammo = good_data("Nonlethal Magazines Pack", list(1, 10), null),
			/obj/item/computer_hardware/hard_drive/portable/design/lethal_ammo = good_data("Lethal Magazines Pack", list(1, 10), null),
		...
		"Tools and Equipment" = list(
			...
			/obj/item/tool/omnitool = good_data("\"Munchkin 5000\"", list(1, 3), null),
