/obj/item/weapon/gun/energy/shrapnel/corsair/enforcer
	...
	init_firemodes = list(
		...
		list(mode_name="Auto shot", projectile_type=/obj/item/projectile/bullet/pistol/rubber, mode_type = /datum/firemode/automatic, fire_delay=3  , charge_cost=125, icon="auto"),
	)
