...
/obj/item/gun/projectile/automatic/whitenail/Initialize()
	. = ..()
	START_PROCESSING(SSobj, src)
	update_icon()

/obj/item/gun/projectile/automatic/whitenail/Process() // increments counter by one per tick until it reaches gun's rebuild_time var
	rebuild_tick++
...
/obj/item/gun/projectile/automatic/whitenail/proc/generate_ammo() // generates ammo in the loaded mag
...
/obj/item/gun/projectile/automatic/whitenail/Destroy()
	STOP_PROCESSING(SSobj, src)
	.=..()

/obj/item/gun/projectile/automatic/whitenail/load_ammo(obj/item/A, mob/user)
	.=..()

/obj/item/gun/projectile/automatic/whitenail/unload_ammo(mob/user, var/allow_dump=1) // empties mag on eject
	if(ammo_magazine)
...
/obj/item/gun/projectile/automatic/whitenail/on_update_icon()
	..()
...
/obj/item/gun/projectile/automatic/whitenail/blacktalon
...
/obj/item/gun/projectile/automatic/whitenail/greyclaw
...
/obj/item/gun/projectile/automatic/whitenail/greyclaw/load_ammo(obj/item/A, mob/user) // prevents grey claw from loading pellets when set to slug mode after inserting a mag
	.=..()
	greyclaw_swap(ammo_magazine)

/obj/item/gun/projectile/automatic/whitenail/greyclaw/toggle_firemode()
	..()
	if(ammo_magazine)
		greyclaw_swap(ammo_magazine)

/obj/item/gun/projectile/automatic/whitenail/greyclaw/proc/greyclaw_swap(var/obj/item/ammo_magazine/greyclaw/M)
