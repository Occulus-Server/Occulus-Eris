...
/obj/item/trash/snack_bowl/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W,/obj/item/material/shard) || istype(W,/obj/item/reagent_containers/food/snacks))
		var/obj/item/reagent_containers/food/snacks/csalad/S = new(get_turf(src))
		S.attackby(W,user)
		qdel(src)
	..()
...
/obj/item/reagent_containers/food/snacks/csalad
	name = "salad"
...
/obj/item/reagent_containers/food/snacks/csalad/attackby(obj/item/W as obj, mob/user as mob)
...
/obj/item/reagent_containers/food/snacks/csalad/proc/update()
...
/obj/item/reagent_containers/food/snacks/csalad/Destroy()
	for(var/obj/item/O in ingredients)
		qdel(O)
	. = ..()

/obj/item/reagent_containers/food/snacks/csalad/examine(mob/user)
	..(user)
	var/obj/item/O = pick(contents)
	to_chat(user, SPAN_NOTICE("You think you can see [O.name] in there."))

/obj/item/reagent_containers/food/snacks/csalad/attack(mob/M as mob, mob/user as mob, def_zone)
	var/obj/item/shard
