...
//OCCULUS EDIT - Really janky thing to make custom blood colors work. It's a prerequisite for custom species traits as well.
	var/datum/species/S = character.species  //define S as the character's species
	var/datum/species/new_S = S.produceCopyLite(character)  //create an instanced copy of the character's species that cannot be affected by other players

	//Any additional species-specific modifications can be made here
	new_S.blood_color = blood_color  //applies custom blood color
...
//support procs from here on out


//////////////////////////////////////////////////////////////////////////////////////////////////////////
// THE ORIGINAL PRODUCE COPY PROC FOR REFERENCE IN CASE WE DECIDE TO PORT CUSTOM SPECIES TRAITS LATER ON
//////////////////////////////////////////////////////////////////////////////////////////////////////////
// This proc just creates a new instance of a species to allow for individual customization of species specific things such as blood color and traits without affecting other already-spawned players.
/*
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
// THE PRODUCE COPY PROC WE'RE USING FOR BLOOD COLORS ONLY
//////////////////////////////////////////////////////////////////////////////////////////////////////////

/datum/species/proc/produceCopyLite(var/mob/living/carbon/human/H)
	ASSERT(src)
	ASSERT(istype(H))
	var/datum/species/new_copy = new src.type()
