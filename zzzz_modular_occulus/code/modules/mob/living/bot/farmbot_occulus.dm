...
/mob/living/bot/farmbot
	...
	var/refills_water = 1
	var/uproots_weeds = 1
	var/replaces_nutriment = 1
	var/collects_produce = 1
	var/removes_dead = 1
	var/voice_synth = 0
...
/mob/living/bot/farmbot/attack_hand(var/mob/user as mob)
	...
	if(.)
		return
	var/dat = ""
	dat += "<TT><B>Automatic Hydroponic Assistance Unit v1.1</B></TT><BR><BR>"
	...
	user << browse("<HEAD><TITLE>AHA v1.1 controls</TITLE></HEAD>[dat]", "window=autofarm")
