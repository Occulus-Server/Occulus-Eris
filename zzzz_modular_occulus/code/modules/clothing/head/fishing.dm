...
/obj/item/clothing/head/fishing
	...
	icon = 'zzzz_modular_occulus/icons/inventory/head/item_fishing.dmi'
	icon_state = "greensoft0"
	item_state_slots = list(slot_r_hand_str = "helmet", slot_l_hand_str = "helmet", slot_head_str = "greensoft0")
	item_icons = list(
		slot_l_hand_str = 'icons/mob/items/lefthand_hats.dmi',
		slot_r_hand_str = 'icons/mob/items/righthand_hats.dmi',
		slot_head_str = 'zzzz_modular_occulus/icons/inventory/head/mob_fishing.dmi'
		)
...
/obj/item/clothing/head/fishing/Initialize()
	...
	//75% chance of it just being a basic women/fish combo
	if(prob(80))
