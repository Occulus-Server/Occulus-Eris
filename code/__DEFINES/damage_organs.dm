...
#define BP_B_R_HAND "right carpals" // Occulus Addition - Adds hands and feet
#define BP_B_L_HAND "left carpals" // Occulus Addition - Adds hands and feet
#define BP_B_L_LEG  "left femur"
#define BP_B_R_LEG  "right femur"
#define BP_B_L_FOOT "left tibia" // Occulus Addition - Adds hands and feet
#define BP_B_R_FOOT "right tibia" // Occulus Addition - Adds hands and feet

// Unique carrion Organs.
#define BP_SPCORE   "spider core"
#define BP_BRAIN_CULTIST "twisted mind"// Occulus Addition - Occultist brain object
