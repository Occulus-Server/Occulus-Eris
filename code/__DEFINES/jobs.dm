...
#define JOBS_SECURITY "Aegis Commander","Aegis Gunnery Sergeant","Aegis Inspector","Aegis Operative","Aegis Medical Specialist" //Occulus Edit Start - Our own titles
#define JOBS_COMMAND "Captain","First Officer","Ensign","Aegis Commander","Free Trade Union Merchant","Chief Engineer","Chief Medical Officer","Chief Science Officer","Chaplain" 
