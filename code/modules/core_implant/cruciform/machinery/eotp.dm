...
/obj/machinery/power/eotp/proc/power_release()
	...
	for(var/disciple in disciples)
		to_chat(disciple, SPAN_NOTICE("A faint tingling sensation washes over you. Mekhane has bestowed a blessing upon his children. Check the [src] if you don't actually feel anything."))	//OCCULUS EDIT - Lore compliance change
