...
/obj/item/clothing/under/rank/preacher
	desc = "Ceremonial garb of Mekhane preachers." // Occulus Edit - NeoTheology > Mekahne
	name = "preacher vestments"
	icon_state = "preacher"
	item_state = "w_suit"

/obj/item/clothing/under/rank/acolyte
	desc = "Ceremonial garb of Mekhane disciples." // Occulus Edit - NeoTheology > Mekahne
...
/obj/item/clothing/under/rank/first_officer
	desc = "A jumpsuit worn by someone who works in the position of \"Head of Personnel\"." // Occulus Edit - Remove Eris corp. references
	name = "head of personnel's jumpsuit" // Occulus Edit - Remove Eris corp. references
	icon_state = "hop"
	item_state = "b_suit"
