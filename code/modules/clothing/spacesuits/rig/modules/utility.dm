...
/obj/item/rig_module/cape/te
	name = "engineering cape" // Occulus Edit - Remove Eris corp. references
	desc = "A tough regal cape, imprinted with a large wrench emblem." // Occulus Edit - Remove Eris corp. references
	suit_overlay_active = "cape_te"
	suit_overlay_inactive = "cape_te"
	suit_overlay_mob_only = 1

	interface_name = "Engineering Cape" // Occulus Edit - Remove Eris corp. references
