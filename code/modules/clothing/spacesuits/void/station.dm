...
/obj/item/clothing/head/space/void/security
	name = "aegis voidsuit helmet"  // Occulus Edit - Remove Eris corp. references
...
/obj/item/clothing/suit/space/void/science
	...
	desc = "A heavy space suit designed for work in hazardous environment without impairing mobility. Features several advanced layers of armor."  // Occulus Edit - Remove Eris corp. references
