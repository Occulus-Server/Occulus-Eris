...
/obj/machinery/power/long_range_scanner
	...
	var/input_cap = 70 KILOWATTS		// Currently set input limit. Set to 0 to disable limits altogether. The shield will try to input this value per tick at most. Occulus Edit
