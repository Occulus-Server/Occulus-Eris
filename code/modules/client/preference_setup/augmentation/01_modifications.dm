/datum/preferences
	...
	var/global/list/r_organs = list(BP_HEAD, BP_R_ARM, BP_R_HAND, BP_CHEST, BP_R_LEG, BP_R_FOOT, BP_GROIN)
	var/global/list/l_organs = list(BP_EYES, BP_L_ARM, BP_L_HAND,  BP_L_LEG, BP_L_FOOT, OP_HEART, OP_KIDNEYS, OP_STOMACH, BP_BRAIN, OP_LUNGS, OP_LIVER)
