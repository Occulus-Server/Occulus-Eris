...
/obj/item/electronics/circuitboard/make_old(low_quality_oldification)
	...
	if(. && prob(75) && (!low_quality_oldification))
		...
		build_path = pick(/obj/machinery/washing_machine, /obj/machinery/shower, /obj/machinery/holoposter, /obj/machinery/holosign) // Occulus Edit - Remove obj/machinery/broken from build pool
