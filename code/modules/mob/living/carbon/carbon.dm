...
/mob/living/carbon/throw_item(atom/target)
	...
	if(istype(item, /obj/item/stack/throwing_knife))
		...
		V.throwforce = 35 / (1 + 100 / ROB_throwing_damage) + 10 //soft cap; This would result in knives doing 10 damage at 0 rob, 20 at 50 ROB, 25 at 100 etc.  // OCCULUS EDIT - Fixed formula
		if(V.amount == 1)
