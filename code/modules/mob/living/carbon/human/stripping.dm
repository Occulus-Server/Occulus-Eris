/mob/living/carbon/human/proc/handle_strip(var/slot_to_strip,var/mob/living/user)
	...
	switch(slot_to_strip)
		...
		if("pockets")
			if(!user.stats.getPerk(PERK_FAST_FINGERS) || (user.get_equipped_item(slot_gloves) == /obj/item/clothing/gloves/sneak)) //occulist edit
	...
	if(stripping)
		if((target_slot == r_hand || target_slot == l_hand) && (user.stats.getPerk(PERK_FAST_FINGERS)) || (user.get_equipped_item(slot_gloves) == /obj/item/clothing/gloves/sneak)) //occulist pickpocket glove edit
		...
		if((slot_to_strip == r_hand || slot_to_strip == l_hand) && user.stats.getPerk(PERK_FAST_FINGERS) || (user.get_equipped_item(slot_gloves) == /obj/item/clothing/gloves/sneak)) //occulist pickpocket glove edit
