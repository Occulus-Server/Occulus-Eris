...
/datum/species
	...
	var/list/has_process = list(    // which required-process checks are conducted and defalut organs for them.
		...
		OP_KIDNEYS =  /obj/item/organ/internal/kidneys, // Occulus Edit - One Kidney
	...
	var/list/has_limbs = list(
		...
		BP_L_HAND = new /datum/organ_description/hand/left, // Occulus Edit Start - Hands/Feet
		BP_R_HAND = new /datum/organ_description/hand/right,
		BP_L_FOOT = new /datum/organ_description/foot/left,
		BP_R_FOOT = new /datum/organ_description/foot/right // Occulus Edit End
		)
