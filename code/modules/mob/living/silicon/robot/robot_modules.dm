...
/obj/item/weapon/robot_module/standard/New(var/mob/living/silicon/robot/R)
	...
	src.modules += new /obj/item/weapon/tool/baton/stun/robot(src)
...
/obj/item/weapon/robot_module/engineering/general/New(var/mob/living/silicon/robot/R)
	...
	src.emag = new /obj/item/weapon/tool/baton/stun(src)
...
/obj/item/weapon/robot_module/security/respawn_consumable(var/mob/living/silicon/robot/R, var/amount)
	...
	if(T.cell.charge < T.cell.maxcharge)
		...
		T.charge_tick = 0
	var/obj/item/weapon/tool/baton/stun/robot/B = locate() in src.modules
	if(B && B.cell)
		B.cell.give(amount)
