/datum/trade_station/station_zarya
	name_pool = list("FTS 'Zarya'" = "Free Trade Station 'Zarya'. They're sending a message. \"Privet, this is Free Station 'Zarya'. We have everything for sale here. Don't be afraid to come aboard and check our wares!\".")
