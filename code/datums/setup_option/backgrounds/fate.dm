...
/datum/category_item/setup_option/background/fate/noble
	...
	desc = "You are of a prestigious family or lineage. Maybe you're self-made. Maybe you're the heir to a fortune.\
			...
			Stay safe, star-child."  // Occulus Edit - Remove Eris corp. reference
...
/* /datum/category_item/setup_option/background/fate/oborin_syndrome // Occulus Removal - No supporting lore
...
/datum/category_item/setup_option/background/fate/lowborn
	name = "Lowborn"
	// Occulus Edit: Different description / restrictions
