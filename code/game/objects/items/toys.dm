...
/obj/item/toy/figure/serbian
	...
	desc = "A curiously unbranded figurine, the olive drab a popular pick for many independent mercenary outfits. Rocket launcher not included."  // Occulus Edit - Rename serbian reference
	icon_state = "serbian"

/obj/item/toy/figure/acolyte
	name = "acolyte figurine"
	desc = "Church of Mekhane \"New Faith Life\" brand figurine of an acolyte, hooded both physically and spiritually from that which would lead them astray." // Occulus Edit - Remove Eris corp. reference
	icon_state = "acolyte"
...
/obj/item/toy/figure/vagabond
	...
	Must have been custom-made to commemorate the Northern Light's doomed voyage."  // Occulus Edit - Remove Eris corp. reference
	icon_state = "vagabond"
