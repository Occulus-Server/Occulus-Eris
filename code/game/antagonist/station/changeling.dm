/datum/antagonist/carrion
	...
	Your enemies are many, and your biology can be easily discerned in the health scanner. You should be wary." // Occulus Edit - Tweak to say you can be found out in the scanner
