...
/proc/generate_titles() //Episode # + title
	...
	if(!GLOB.end_credits_title)
		...
		possible_titles += "A VERY [pick("CORPORATE", "NANOTRASEN", "SOLGOV", "HAPHAESTUS", "DAIS", "XENOLIFE", "EXPEDITIONARY", "DEEPMAINT", "PLASMA", "MARTIAN", "NULLSPACE")] [pick("CHRISTMAS", "EASTER", "HOLIDAY", "WEEKEND", "THURSDAY", "VACATION")]"
